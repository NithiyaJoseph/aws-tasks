...
"""
    ...
    ses_client_emaillist=ses_client. list_identities (IdentityType = 'EmailAddress')
    if ses_client_emaillist['Identities'] != [] :
        for i in ses_client_emaillist['Identities']:
            if i == email:
                print('mail need to verifiy and rotation mail will be sent!!!')
                try:
